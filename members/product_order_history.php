...
if($producer_id != $producer_id_you && $authorization['administrator'] === false)
  {
...
while ($row = mysql_fetch_array($sql))
  {
    ...
    $contact_phone = $row['mobile_phone'];
    ...
    $content_body .= '
      ...
      <td '.$new_section.'>'.$contact_phone.'</td>
...
$content_head = '
  ...
  <table align="center" border="0" cellspacing="0" cellpadding="2" width="800">
  <tr class="prodhead">
