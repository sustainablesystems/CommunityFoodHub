...
$display_form_top .= '
  <h1>'.date('Y').' '.SITE_NAME.'<br>Producer Registration</h1>
...
$display_form_text .= '
  ...
  The following checked items will be displayed on the site
    ...
    ['.strtr ($pub_phonec, " 01", "  X").'] Publish Contect Phone
    ['.strtr ($pub_web, " 01", "  X").'] Publish Website
    ...
    <table cellspacing="15" cellpadding="2" width="100%" border="1" align="center">
        ...
        <td>
          <table>
            ...
            <tr>
              ...
              <td>http:// <input maxlength="50" size="45" name="website" value="'.htmlentities ($website, ENT_QUOTES).'"/></td>
            </tr>
          </table>
        </td>
      </tr>
      ...
      <tr>
        <td>
          <table>
            <tr>
              <td class="form_key" colspan="6">The following privacy settings affect which of your
            ...
            <tr>
              ...
              <td class="form_key"><strong>Publish Contact Phone</strong></td>
              <td align="right"><input type="checkbox" name="pub_web" value="1" '.$pub_web_check.'/></td>
              <td class="form_key"><strong>Publish Website</strong></td>
            </tr>
          </table>
        </td>
      </tr>
          ...
          <table>
            <tr>
              <td class="form_key"><strong>Product Types:</strong><br>
                List keywords like lettuce, berries, soap, etc.</td>
            </tr>
            <tr>
...
if (count ($error_array) == 0 && $_POST['action'] == 'Submit') // For new members
  {
    ...
    $result = update_member_auth($member_id, $business_name);
    ...
    $display_form_html = save_producer_file($producer_id);
