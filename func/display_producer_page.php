...
function prdcr_info ($producer_id, $is_logged_in)
  {
    global $connection;
    ...
    while ( $row = mysql_fetch_array($rsr) )
      {
        ...
        $display .= '<div align="right"><a href="'.PATH.'prdcr_display_quest.php?pid='.$producer_id
          .($is_logged_in ? '&members=true' : '')
          .'">View answers to original producer questionnaire</a></div>';
        $display .= '</td></tr></table>';
      }
    return $display;
  }
