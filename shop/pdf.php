    ...
    function writepdf()
      {
        ...
        // Added --no-links (to get rid of incorrect hyperlinks for box contents)
        exec('htmldoc --webpage --no-links --browserwidth 800 --left 36 --right 36 --top 24 -t pdf '.FILE_PATH.PATH.'pdf/'.$filename.'.html -f '.FILE_PATH.PATH.'pdf/'.$filename.'.pdf');
      }
