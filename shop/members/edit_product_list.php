...
elseif ($_SESSION['producer_id_you'])
  ...
  $is_supplier = is_producer_supplier($producer_id);
  $heading_size = "h2";
...
$sql = '
  SELECT
    ...
    '.TABLE_PRODUCT_PREP.'.is_compound,
        ...
        <table border=2 cellpadding=5 cellspacing=0 bgcolor=#EEEEEE>
          <tr>
            <td>
              ...
              <br><br>
              Once changes are submitted, they will be reviewed by the <?php echo ORGANIZATION_TYPE; ?> admins to ensure everything is ok and will be released to the public once the ordering cycle is open. They will not be public prior to the opening of the order cycle.
              <br><br>
