        ...
        $producer_orders_bycustomerstorage .= '
          <tr bgcolor="#DDDDDD">
            <td colspan="8" id="'.$member_id.'">
              <font size="4"><font color="#770000">'.(convert_route_code($basket_id, $member_id, $last_name, $first_name, $business_name, $a_business_name, $delcode_id, $delcode_id, $deltype, $truck_code, $storage_code, $show_mem, $show_mem2, $product_name, $quantity, $ordering_unit, $product_id, $item_price, $delcode)).'</font></font> /
...
if ( $display_unit_price != 0 )
  {
    $display_price .= $font.' '.CURSYM.number_format($display_unit_price, 2).'/'.$pricing_unit.'';
  }
...
if ( $extra_charge != 0 )
  {
    ...
    $producer_orders_bycustomerstorage .= '
      ...
      // $producer_orders_bycustomerstorage .= "<tr><td colspan=\"8\">Customer Quantity: $total_pr Customer subtotal: ".CURSYM.number_format($subtotal_pr,2)."</td></tr>";
  }
$querya = '
  SELECT
    transaction_name,
...
while( $resulta = mysql_fetch_array($sqla) )
  {
    $producer_orders_bycustomerstorage .= '
      ...
      <tr align="center">
        ...
        <td align="right" valign="top">'.CURSYM.number_format($resulta['transaction_amount'], 2).'</td>
