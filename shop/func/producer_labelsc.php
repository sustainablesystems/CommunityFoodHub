...
while ( $row = mysql_fetch_array($resultpr) )
  {
    ...
    if ( $sc == $row['storage_code'] && $m == $member_id )
      ...
      {
        $display_label .= '<br />'.(convert_route_code($basket_id, $member_id, $last_name, $first_name, $business_name, $a_business_name, $delcode_id, $delcode_id, $deltype, $truck_code, $storage_code, $show_mem, $show_mem2, $product_name, $quantity, $ordering_unit, $product_id, $item_price, $delcode))."<br />";
