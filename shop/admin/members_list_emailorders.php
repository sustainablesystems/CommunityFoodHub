...
<table width="800">
  <tr>
    <td align="left">
      <div align="center">
        <h3>Member Ordering for Delivery #<?php echo $delivery_id; ?>: <?php echo $mail_count;?> Members</h3>
      </div>
...
<?php } ?>
      ...
      <br /><br />
    <div id="fancy"><?php echo $fancy_display;?></div>
    <div id="plain" style="display:none"><?php echo $plain_display;?></div>
