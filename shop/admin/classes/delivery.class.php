...
class Delivery
{
  ...
  function printChangeDeliveryInfoForm($basket_id, $member_id){
    ...
    //check the current collection type
    switch($deltype){
      case "H":
        $chk1 = "checked";
        break;
    ...
    /*
     * Currently only supporting pick up from collection location.  These options removed from input list below:
     * <input type='radio' name='deltype' value='H' $chk1>Home Delivery</input><br />
     * <input type='radio' name='deltype' value='W' $chk2>Work Delivery</input><br />
     */
    $display.="<td>
          <input type='radio' name='deltype' value='P' $chk3 >Pick up from Collection Location</input>
          </td>
          </tr>
          <tr>
          <td>
          ...
          <td>
          <input type='submit' value='Change Location Information' />
          </td>
          </tr>";
