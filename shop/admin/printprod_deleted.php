...
<font size="+3"><?php echo ucfirst (SITE_NAME); ?> <?php echo $date_today;?> List of Products Not Available Until Further Notice - Do not order in <?php echo $this_month;?>!!!</font>
<hr color="#000000" noshade size="2" width="100%">
<?php echo $display;?>
<!-- CONTENT ENDS HERE -->
</body>
