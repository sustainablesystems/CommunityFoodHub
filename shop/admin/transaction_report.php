...
<table style="border:1px solid;font-family:Verdana;font-size:10pt;">
  <tr style="background-color:#EEEEEE;">
    ...
    <td align="center">
      Member ID: <input type="text" name="search_criteria[transaction_member_id]" value="<?php  echo $_POST['search_criteria']['transaction_member_id'];?>" size="4" maxlength="8">
      Delivery ID: <input type="text" name="search_criteria[transaction_delivery_id]" value="<?php  echo $_POST['search_criteria']['transaction_delivery_id'];?>" size="4" maxlength="4">
      Batch No.: <input type="text" name="search_criteria[transaction_batchno]" value="<?php  echo $_POST['search_criteria']['transaction_batchno'];?>" size="6" maxlength="8">
<?php
...
if ( $_POST['search_criteria']['month2'] )
  {
    echo '  <option value="'.$_POST['search_criteria']['month2'].'">'.$_POST['search_criteria']['month2'].'</option>';
  }
else
  {
    ...
    foreach($transactions as $key=>$row)
      {
        ...
        echo '
          <tr '.$style.'>
            ...
            <td align="right">'.CURSYM.$row['transaction_amount'].'</td>
