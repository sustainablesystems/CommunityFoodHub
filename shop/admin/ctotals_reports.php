...
while ( $row = mysql_fetch_array($result) )
  {
    ...
    $sqldp = '
      ...
      GROUP BY
        member_id';
    //initialize variables in case there was no data for the prior case
    $prev_paypal = 0;
    $prev_grand_total = 0;
    $amount_paid = 0;
    $previous_balance = 0;
    ...
    $other_adjustments = number_format($adj_new['adjustment_sum'], 2, '.', '')
    ...
    $missing_total = $missing_total + number_format($adjm_new['adjustment_sum'], 2, '.', '');
    $nonadj_total_total = $nonadj_total_total + number_format($nonadj_total, 2, '.', '') + 0;
    $workcredit_total = $workcredit_total + number_format($adjw_new['adjustment_sum'], 2, '.', '');
    $producer_discount_total = $producer_discount_total + number_format($adjp_new['adjustment_sum'], 2, '.', '');
    $producer_credit_total = $producer_credit_total + number_format($adjpc_new['adjustment_sum'], 2, '.', '');
    $other_adjustments_total = $other_adjustments_total + $other_adjustments + 0;
    $adjustment_total =$adjustment_total + number_format($adj_new['adjustment_sum'], 2, '.', '');
    ...
    $display_month .= '
      <tr>
        ...
        <td align="right" valign="top"><font face="arial" size="-1">'.CURSYM.number_format($row['subtotal'], 2).'</td>
        <td align="right" valign="top"><font face="arial" size="-1">'.CURSYM.number_format($cust_salestax, 2).'</td>
        <td align="right" valign="top"><font face="arial" size="-1">'.CURSYM.number_format($coop_charges, 2).'</td>
        <td align="right" valign="top"><font face="arial" size="-1">'.CURSYM.number_format($row['delivery_cost'], 2).'</td>
        <td align="right" valign="top"><font face="arial" size="-1">'.CURSYM.number_format($coop_donations, 2).'</td>
        <td align="right" valign="top"><font face="arial" size="-1">'.CURSYM.number_format($non_coop_donations, 2).'</td>
        <td align="right" valign="top"><font face="arial" size="-1">'.CURSYM.number_format($grand_total, 2).'</td>
        <td align="right" valign="top"><font face="arial" size="-1">'.CURSYM.number_format($other_adjustments, 2).'</td>
        ...
        <td align="right" valign="top"><font face="arial" size="-1">'.CURSYM.number_format($cash_discount, 2).'</td>
        <td align="right" valign="top"><font face="arial" size="-1"><b>'.CURSYM.number_format($row['grand_total'], 2).'</b> '.$minus_paypal.'</td>
        <td align="right" valign="top"><font face="arial" size="-1">'.CURSYM.number_format($previous_balance, 2).'</td>
        <td align="right" valign="top"><font face="arial" size="-1">'.CURSYM.number_format($invoice_total + $previous_balance, 2).'</td>
        <td align="right" valign="top"><font face="arial" size="-1">'.CURSYM.$row['amount_paid'].' '.$unfinalized.'</td>
        <td align="right" valign="top"><font face="arial" size="-1">'.CURSYM.number_format($discrepancy + $previous_balance, 2).'</td>
...
$display_totals .= '
  <tr>
    ...
    <td align="right" valign="top"><font face="arial" size="-1"><br><b>'.CURSYM.number_format($subtotal_all, 2).'</b></td>
    <td align="right" valign="top"><font face="arial" size="-1"><br><b>'.CURSYM.number_format($total_salestax, 2).'</b></td>
    <td align="right" valign="top"><font face="arial" size="-1"><br><b>'.CURSYM.number_format($coop_charges_total, 2).'</b></td>
    <td align="right" valign="top"><font face="arial" size="-1"><br><b>'.CURSYM.number_format($home_delivery_total,2).'</b></td>
    <td align="right" valign="top"><font face="arial" size="-1"><br><b>'.CURSYM.number_format($coop_donations_total, 2).'</b></td>
    <td align="right" valign="top"><font face="arial" size="-1"><br><b>'.CURSYM.number_format($non_coop_donations_total, 2).'</b></td>
    <td align="right" valign="top"><font face="arial" size="-1"><br><b>'.CURSYM.number_format($total_for_accountants, 2).'</b></td>
    <td align="right" valign="top"><font face="arial" size="-1"><br><b>'.CURSYM.number_format($other_adjustments_total, 2).'</b></td>
    <td>&nbsp;</td>
    <td align="right" valign="top"><font face="arial" size="-1"><br><b>'.$total_quantity.'</b></td>
    <td align="right" valign="top"><font face="arial" size="-1"><br><b>'.CURSYM.number_format($cash_discount_total, 2).'</b></td>
    <td align="right" valign="top"><font face="arial" size="-1"><br><b>'.CURSYM.number_format($grand_total_all, 2).'</b></td>
    <td align="right" valign="top"><font face="arial" size="-1"><br><b><!--previous--></b></td>
    <td align="right" valign="top"><font face="arial" size="-1"><br><b>'.CURSYM.number_format($invoice_total_total,2).'</b></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>';
...
<h1>Breakdown of Customer Payments for <?php echo $delivery_date;?></h1>
<b>Total Products Sold: <?php echo $quantity_all;?> Products &nbsp;&nbsp;&nbsp;Total Orders: <?php echo $numtotal;?></b>
<br><a href="ctotals_onebutton.php?delivery_id=<?php echo$delivery_id;?>">View/Update Customer Payments</a> |
<a href="history_saved.php">Previous Order Cycles</a> |
<a href="ctotals_reports.php?delivery_id=<?php echo$delivery_id;?>&spreadsheet=1">Print View</a> <font size="-1">(print as landscape for best results)</font>
<br><font color="#CC9900"><?php echo $message;?></font>
<hr>
<h3>Grand Total: <?php  echo CURSYM.number_format($total_for_accountants,2);?></h3>
(Products Subtotal(#1) + Sales tax(#2) + <?php echo ucfirst (ORGANIZATION_TYPE); ?> Charges(#3) + Home Delivery (#4) + (-)Missing Ticket Items(#5)
...
if (!$_REQUEST['spreadsheet'])
  ...
  <tr <?php echo $heading_color;?>>
    ...
    <th valign="bottom"><font face="<?php echo $fontface;?>" size="-1">3. <?php echo ucfirst (ORGANIZATION_TYPE); ?> Charges</th>
    <th valign="bottom"><font face="<?php echo $fontface;?>" size="-1">4. Home Delivery</th>
    <th valign="bottom"><font face="<?php echo $fontface;?>" size="-1">7. Donations to the <?php echo ucfirst (ORGANIZATION_TYPE); ?></th>
...
3. <?php echo ucfirst (ORGANIZATION_TYPE); ?> Charges <br/>Shipping & Handling<br/><br/>
...
10. Producer Credits <br/>Where a producer&#146;s member account is credited revenue from the <?php echo ORGANIZATION_TYPE; ?><br/><br/>
...
19. Amount Paid<br/>If this column has an 'unfinalised' note and you find the totals incorrect on this chart, finalise and unfinalise so that the current numbers get saved and show in this chart.<br/>
<?php
if (!$_REQUEST['spreadsheet'])
  {
