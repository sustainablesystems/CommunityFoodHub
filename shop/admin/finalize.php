...
if ( $delivery_id > 0 && $ms > 0 && $mf > 0 )
  {
    ...
    while ( $row = mysql_fetch_array($rs) )
      { 
        geninvoice($row['member_id'],$row['basket_id'],$delivery_id,"adminfinalize",true,true);
      }
    echo '<div align="center">'.$num_orders.' invoices finalised.</div>';
  }
else
  {
    echo '<div align="center">No invoices finalised.</div>';
  }
