  ...
  <tr>
    <td align="left" colspan="2">
      <table width="100%">
        ...
        <tr>
          <td align="left">
            <form action="<?php echo $PHP_SELF.'?delivery_id='.$delivery_id.'&producer_id='.$producer_id ?>" method="post">
            ...
            <table cellspacing="3" border="0" cellpadding="0">
              <tr>
                ...
                <td><?php echo "$sort1_display" ?></td>
                <td>(with headers)</td>
              </tr>
              <tr>
                <td align="right">then by</td>
                <td><?php echo "$sort2_display" ?>
                <td>(with headers)</td>
              </tr>
              <tr>
                <td align="right">then by</td>
                <td><?php echo "$sort3_display" ?>
                <td>(with headers)</td>
              </tr>
              <tr>
                <td align="right">then by</td>
                <td><?php echo "$sort4_display" ?>
                <td>(no headers)</td>
              </tr>
              <tr>
